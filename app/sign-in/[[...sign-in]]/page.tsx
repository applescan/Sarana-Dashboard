...
export default function Page() {
  return (
    <section className="rounded-3xl border border-white/10 bg-card/80 p-4 shadow-glow sm:p-6 lg:p-10">
      <div className="grid items-start gap-8 lg:items-center lg:gap-10 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="space-y-6 text-secondary-foreground">
          ...
          <div className="space-y-4 rounded-2xl border border-white/5 bg-white/5 p-4 w-full">
